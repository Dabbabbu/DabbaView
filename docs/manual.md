...
버전 3.2.9 · macOS / Windows · 변경 이력은 [CHANGELOG](../CHANGELOG.md)
...
도구 막대·탭·메뉴 글자가 작아 보이면 **View ▸ 🔍 화면 크기**에서 키우세요.

- **크게** `⌘⇧+` / **작게** `⌘⇧-` — 90 · 100 · 110 · 125 · 150 · 175% 단계로 바뀝니다
- 목록에서 원하는 비율을 직접 고를 수도 있고, 고른 값은 다음에 열 때도 유지됩니다
