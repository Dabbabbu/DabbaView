...
def create_icon():
    ...
    # 앱 시작 화면용 로고 (radiantview 패키지에 포함되어 번들에 들어감)
    os.makedirs("radiantview/resources", exist_ok=True)
    img.resize((256, 256), Image.LANCZOS).save("radiantview/resources/logo.png")

    # .iconset 디렉토리 생성
    iconset_dir = "resources/RadiantView.iconset"
    ...
    img.save("resources/radiantview.ico",
             sizes=[(16, 16), (24, 24), (32, 32), (48, 48),
                    (64, 64), (128, 128), (256, 256)])
    print("✅ resources/radiantview.ico 생성 완료!")

    # iconutil로 .icns 생성 (macOS 전용)
    try:
        subprocess.run(
            ["iconutil", "-c", "icns", iconset_dir,
             "-o", "resources/RadiantView.icns"],
            check=True
        )
        print("✅ resources/RadiantView.icns 생성 완료!")
